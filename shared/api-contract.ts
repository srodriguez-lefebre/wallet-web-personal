...
export const apiOperations = [
  ...
  op({ operationId: "goalReservations.release", method: "POST", path: "/api/goal-reservations/release", auth: "session", stability: "stable", body: goalReservationReleaseSchema, response: anyResponse, successStatus: 201, errors: [400, 401, 409, 500], summary: "Release part or all of a goal reservation" }),
